...
TOOL_PROMPT = (
    ...
    "- Pen is near the left portion of that field's line or box: "
    "say 'Ready to write, <field name>.'\n"
    ...
    "start of <field name>.'\n"
    "- Pen is not yet over any field: give a direction cue toward the nearest "
