...
TOOL_PROMPT = (
    ...
    "The form is in English, so writing starts at the left side of each "
    "fillable line or box. Guide the pen toward the left portion of the "
    "nearest field. Use this scale:\n"
    "- Pen is near the left side of the field (anywhere in roughly the left "
    "third): say 'Ready to write, <field name>.'\n"
    "- Pen is in the middle of the field: say 'Move left, <field name>.'\n"
    "- Pen is far to the right of the field: say 'Move left, far from start "
    "of <field name>.'\n"
    "- Pen is not yet over the field at all: give a direction cue toward the "
    "field, e.g. 'Move down to <field name>.'\n"
