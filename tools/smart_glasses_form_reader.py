...
TOOL_PROMPT = (
    ...
    "IMPORTANT spatial convention: on paper forms, a person writes ON or "
    "BESIDE the field's line — never below it. The text a person writes sits "
    "on top of the line. Use this to identify which field the pen is "
    "targeting: the field whose line is at the same level as or just below "
    "the pen tip.\n"
    ...
    "- Pen tip is resting directly on (touching or at the level of) the "
    "field's line or the bottom edge of its box, AND in the left portion of "
    "that field: say 'Writing mode. Ready to write, <field name>.'\n"
    "- Pen tip is above the line (not yet touching it) but in the left "
    "portion: say 'Writing mode. Move down to <field name>.'\n"
